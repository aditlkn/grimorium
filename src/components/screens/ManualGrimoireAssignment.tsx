      ...
      <div className='flex-1 px-4 py-4 max-w-lg mx-auto w-full overflow-y-auto space-y-4'>
            ...
            {seatPositions.map(({ seat, x, y }) => {
              ...
              return (
                <button
                  key={seat.slotId}
                  type='button'
                  onClick={() => setSelectedSeatId(seat.slotId)}
        ...
        <section className='rounded-2xl border border-white/10 bg-white/5 p-4'>
          <div className='flex items-center gap-2 mb-3'>
            ...
            <h2 className='font-tarot text-sm uppercase tracking-wider text-parchment-100'>
              {t.game.grimoireSelectedSeat}
            </h2>
          </div>

          {selectedSeat ? (
            <div className='space-y-4'>
              <div className='text-xs uppercase tracking-[0.22em] text-parchment-500'>
            ...
            <p className='text-sm text-parchment-400'>{t.newGame.selectSeatToEdit}</p>
          )}
        </section>
